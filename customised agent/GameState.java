...
//        System.out.println("state = " + state);
    ...
    public boolean woodFlameRigid(){
        ...
        if(avPosition.x > 0 && avPosition.x < boardSize - 1 && avPosition.y > 0 && avPosition.y < boardSize - 1) {
            if ((board[avPosition.y + 1][avPosition.x] == Types.TILETYPE.RIGID || board[avPosition.y + 1][avPosition.x] == TILETYPE.FLAMES || board[avPosition.y + 1][avPosition.x] == TILETYPE.WOOD)&&
                    (board[avPosition.y][avPosition.x + 1] == Types.TILETYPE.RIGID || board[avPosition.y][avPosition.x + 1] == TILETYPE.FLAMES || board[avPosition.y][avPosition.x + 1] == TILETYPE.WOOD) &&
                    (board[avPosition.y][avPosition.x - 1] == Types.TILETYPE.RIGID || board[avPosition.y][avPosition.x - 1] == TILETYPE.FLAMES || board[avPosition.y][avPosition.x - 1] == TILETYPE.WOOD)
            ) {
                return true;
