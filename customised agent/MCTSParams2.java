...
public class MCTSParams2 implements ParameterSet {
    ...
    public final int MCTS2_HEURISTIC = 2;

    public double epsilon = 1e-6;

    // Parameters
    public double K = Math.sqrt(2);
    public int rollout_depth = 8;//8;//10;
    public int heuristic_method = MCTS2_HEURISTIC;
    ...
    public Map<String, Object[]> getParameterValues() {
        ...
        parameterValues.put("heuristic_method", new Integer[]{CUSTOM_HEURISTIC, ADVANCED_HEURISTIC, MCTS2_HEURISTIC});
    ...
    public Map<String, String[]> constantNames() {
        ...
        names.put("heuristic_method", new String[]{"CUSTOM_HEURISTIC", "ADVANCED_HEURISTIC", "MCTS2_HEURISTIC"});
        return names;
    }
}
