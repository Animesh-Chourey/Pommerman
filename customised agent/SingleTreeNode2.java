...
public class SingleTreeNode2 {
    ...
    SingleTreeNode2(MCTSParams2 p, Random rnd, int num_actions, Types.ACTIONS[] actions) {
        this(p, null, -1, rnd, num_actions, actions, 0, null);
    }

    private SingleTreeNode2(MCTSParams2 p, SingleTreeNode2 parent, int childIdx, Random rnd, int num_actions,
    ...
    {
        //System.out.println("inside single tree node 20"+ params.heuristic_method);
        ...
        else if (params.heuristic_method == params.MCTS2_HEURISTIC) // New method: combined heuristics
            this.rootStateHeuristic = new MCTS2Heuristic(gs);
    }
